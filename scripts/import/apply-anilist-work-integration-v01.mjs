...
const VERSION = 'anilist-work-integration-apply-v0.3'
...
function validatePlan(plan) {
  ...
  const suspicious = suspiciousSearchTextLines(searchText)
  if (suspicious.length) blockers.push('suspicious_title_spacing_after_sanitize')
