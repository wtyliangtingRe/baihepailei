...
const VERSION = 'work-merge-field-plan-v0.2'
...
function markdown(summary, samples) {
  return [
    '# Work Merge Field Plan v0.2',
    '',
    'Read-only field merge plan for verified strict safe same-work groups. This report fixes the v0.1 addition diff direction and remains non-executable.',
    '',
    '## Summary',
    '',
...
async function main() {
  ...
  const outputs = {
    plans: path.join(outDir, 'work-merge-field-plan-v02.plans.jsonl'),
    ready: path.join(outDir, 'work-merge-field-plan-v02-ready.groups.jsonl'),
    blocked: path.join(outDir, 'work-merge-field-plan-v02-blocked.groups.jsonl'),
    summary: path.join(outDir, 'work-merge-field-plan-v02-summary.json'),
    json: path.join(outDir, 'work-merge-field-plan-v02.json'),
    md: path.join(outDir, 'work-merge-field-plan-v02.md'),
  }
