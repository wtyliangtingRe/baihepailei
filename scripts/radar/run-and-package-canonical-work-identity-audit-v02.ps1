...
$auditScript = Join-Path $PSScriptRoot 'audit-canonical-work-identity-v02.ps1'
...
if ($LASTEXITCODE -ne 0) {
  throw 'Canonical Work identity v02 只读数据库审计失败。'
}
...
Write-Host ''
Write-Host 'Canonical Work identity v02 只读审计与打包完成' -ForegroundColor Green
