...
try {
  ...
  & '.\scripts\radar\prepare-radar-public-conclusions-migration-v02.ps1' -CommitAndPush 2>&1 |
  ...
  if ($changedPaths.Count -ne 5 -or
      $expectedIndex.Count -ne 1 -or
      $baselineTs.Count -ne 1 -or
      $baselineJson.Count -ne 1 -or
      $radarTs.Count -ne 1 -or
      $radarJson.Count -ne 1) {
