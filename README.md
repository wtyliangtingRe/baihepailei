...
公开快照位于 `data/public-release/v2/`，清单记录每个 shard 的 SHA-256、行数和字节数。
...
- 4,634 个评级 + 117 个非评级终态 = 4,751 个当前决策范围；
...
2026-09-08：复用前 25 个研究包的既有证据，新增 633 条源记录评级，跳过 4,367 条。现有去重规则下共展示 4,750 部已有结论的作品（4,633 部评级、117 条非评级终态）。原 v1 与 release/rc-20260906 保留。详见 [本轮入站记录](docs/pack-reuse-20260908.md)。
