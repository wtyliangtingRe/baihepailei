...
test('global audit sources parse and v02 reaches normal required-argument validation', () => {
  ...
  const result = spawnSync(process.execPath, [v02Path], { cwd: root, encoding: 'utf8' })
...
test('global audit and wrapper are read-only and leave the dedicated server stopped', () => {
