...
const entityEditor = read('src/app/(frontend)/me/studio/entities/[collection]/[id]/page.tsx')
assert.match(entityEditor, /localizedNames/u)
assert.match(entityEditor, /profileImage/u)
assert.match(entityEditor, /sourceLinksFromText/u)
